...
E_tarski = zeros(1,T+1);
E_tarski_adapt = zeros(T+1,1);
...
for trial=1:n_trials
    ...
    X_tarski = X0;
    X_tarski_adapt = X0;
    E_tarski_adapt(1) = dirichlet(A,X_tarski_adapt,p);
    ...
    for t=2:T+1
        ...
        E_tarski_adapt(t) = dirichlet(A,X_tarski_adapt,p);
    end
    plot(iterations,E_tarski_adapt,'green') %plot energy curve
    plot(iterations,E_tarski,'blue')
